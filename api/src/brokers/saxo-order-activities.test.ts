...
const stateCases: Array<{
    ...
    { name: 'partial fill followed by confirmed cancel', activities: [fill(), fill({ LogId: '2', Status: 'Cancelled', ExecutionPrice: undefined, FillAmount: undefined })], expected: 'CANCELED' },
    ...
    { name: 'placement rejection after confirmed fill', activities: [fill(), fill({ LogId: '2', Status: 'Placed', SubStatus: 'Rejected', ExecutionPrice: undefined, FillAmount: undefined })], expected: 'PARTIALLY_FILLED' },
    { name: 'placement rejection with confirmed placement', activities: [fill({ Status: 'Placed', SubStatus: 'Confirmed', ExecutionPrice: undefined, FillAmount: undefined }), fill({ LogId: '2', Status: 'Placed', SubStatus: 'Rejected', ExecutionPrice: undefined, FillAmount: undefined })], expected: 'NON_TERMINAL' },
    { name: 'placement rejection and confirmed cancel are ambiguous', activities: [fill({ Status: 'Placed', SubStatus: 'Rejected', ExecutionPrice: undefined, FillAmount: undefined }), fill({ LogId: '2', Status: 'Cancelled', ExecutionPrice: undefined, FillAmount: undefined })], expected: 'UNRESOLVED' },
    ...
    { name: 'done for day', activities: [fill({ Status: 'DoneForDay', ExecutionPrice: undefined, FillAmount: undefined })], expected: 'NON_TERMINAL' },
